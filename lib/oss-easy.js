...
(function() {
  ...
  OssEasy = (function() {
    ...
    OssEasy.prototype.uploadFile = function(localFilePath, remoteFilePath, callback) {
      var args;
    ...
    OssEasy.prototype.uploadFiles = function(tasks, callback) {
      ...
      async.eachSeries(localFilePaths, function(localFilePath, eachCallback) {
        return _this.uploadFile(localFilePath, tasks[localFilePath], eachCallback);
      }, callback);
    };
