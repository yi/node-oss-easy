...
(function() {
  ...
  describe("testing oss", function(done) {
    ...
    it("copy multiple file", function(done) {
    ...
    it("capy folder", function(done) {
      oss.copyFolder("test/upload/multiple/", "test/upload/multiple2/", function(err) {
        should.not.exist(err);
        done();
      });
    });
    ...
    it("delete file", function(done) {
      ...
      oss.deleteFile(remoteFilePath, function(err) {
        should.not.exist(err);
        done();
      });
    });
    return it("delete a folder", function(done) {
      oss.deleteFolder("test/upload/multiple/", function(err) {
        oss.deleteFolder("test/upload/multiple2/", function(err) {
          should.not.exist(err);
          done();
        });
      });
